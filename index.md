...
The application will provide an intuitive interface for authors to compose and
format their articles, while also offering a seamless reading experience for
visitors.
...
return within an HTTP response.
...
- Creation date should be autogenerated at article creation and would
  never be updated.
- Updated date will be updated at each article save.
...
- Articles may be modified or deleted only by their authors from the
  detail article page. However, admins can still perform articles
